<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,24&height=200&section=header&text=LESSLIE%20NEWBIGIN&fontSize=55&fontColor=fff&animation=twinkling&fontAlignY=38&desc=Cybersecurity%20Researcher%20%7C%20Ethical%20Hacker%20%7C%20Red%20Team%20Enthusiast&descAlignY=62&descSize=15" width="100%"/>
</div>
...
![Profile Views](https://komarev.com/ghpvc/?username=Lesslie-Newbigin&color=70a5fd&style=for-the-badge&label=PROFILE+VIEWS)
&nbsp;
![Followers](https://img.shields.io/github/followers/Lesslie-Newbigin?style=for-the-badge&color=bf91f3&labelColor=0d1117&label=FOLLOWERS)
...
class CyberSecurityResearcher:
    ...
    toolkit = [
        ...
        "Wireshark", "Metasploit", "ESP32",
    ]

    volunteering = [
        "NCRP National Volunteer    -> May 2025 - Present",
        "Tiruppur Cyber Crime Wing  -> Dec 2025 - Present",
    ]

    currently_building = "CheCore - Offensive Security Toolkit"

    def motto(self):
        return "Learn -> Enumerate -> Exploit -> Patch -> Repeat"
```
...
- Gaining exposure to live cybercrime cases, evidence handling and investigation workflows
- Supporting law enforcement with technical knowledge of attack patterns
...
|:--------|:------|:-----------|
| **Smart Border Security System** | Laser Sensors · ESP32 · IoT | **Team Lead** (SIDP) — laser virtual fence with real-time breach detection |
| **CheCore — Offensive Security Tool** | Python · ESP32 · Kali Linux | Red-team toolkit integrating hardware with ethical hacking techniques |
| **Tamper-Free Evidence System** | Hashing · Cryptography | Kaaval Hackathon — tamper-proof digital evidence for law enforcement |
| **Digital Twin — Missing Persons ID** | Digital Twin · Forensics | Kaaval Hackathon — AI-assisted identity matching for investigations |
| **AI Traffic Monitoring System** | Computer Vision · AI | Kaaval Hackathon — real-time traffic violation detection via AI cameras |
...
| 🚔 | **Tiruppur Cyber Crime Wing** | Active since Dec 2025 |
| 🔄 | **CEH — In Progress** | EC-Council Certified Ethical Hacker |
| 🔄 | **HAM Radio License — In Progress** | RF security and signal analysis |
...
```
CEH (EC-Council)              ->  Recon, Scanning, Exploitation, Post-Exploit, Reporting
Fortinet NSE 4-7 Path         ->  FortiGate, FortiAnalyzer, FortiSIEM, Advanced Threats
HAM / Amateur Radio License   ->  RF Security, SDR, Signal Analysis, Hardware Hacking
Advanced Penetration Testing  ->  Web App, API, Network Pivoting, Active Directory
Firmware Reverse Engineering  ->  ESP32, JTAG, UART, Binwalk, Ghidra, Radare2
Protocol and Packet Analysis  ->  Wireshark, Scapy, Crafted Payloads, IDS/IPS Evasion
AI in Cybersecurity           ->  Anomaly Detection, LLM Security, AI Threat Intelligence
Digital Forensics             ->  Evidence Handling, Chain of Custody, Memory Analysis
```
